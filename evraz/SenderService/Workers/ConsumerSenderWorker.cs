...
{
    public class ConsumerSenderWorker
    {
        private readonly ILogger<ConsumerSenderWorker> _logger;
        private readonly IServiceSettings _settings;
        private readonly IServiceProvider _serviceProvider;

        public ConsumerSenderWorker(ILogger<ConsumerSenderWorker> logger, IServiceProvider services, IServiceSettings settings)
        {
            _logger = logger;
