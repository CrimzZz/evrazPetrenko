...
{
    public class ConsumerOwenWorker
    {
        private readonly ILogger<ConsumerOwenWorker> _logger;
        private readonly IServiceSettings _settings;
        private readonly IServiceProvider _serviceProvider;

        public ConsumerOwenWorker(ILogger<ConsumerOwenWorker> logger, IServiceProvider services, IServiceSettings settings)
        {
            _logger = logger;
